/*
 *  narecord.c - Modified from aplay.c
 *  https://github.com/bear24rw/alsa-utils/blob/master/aplay/aplay.c
 *
 *  Intended to Capture the On-board Mic stream to a File &
 *  send the same stream to Noise-Cancellation Algorithm,
 *  recieve the ouput from algorithm and capture to final noiseless data.
 *
